...
StackPrism 栈棱镜是一个 Chrome / Edge Manifest V3 浏览器扩展，用于检测当前网页使用的技术线索，包括前端框架、前端库、UI / CSS 框架、构建工具、CDN / 托管、Web 服务器、后端框架、开发语言 / 运行时、网站程序、探针 / 监控、RSS / 订阅、CMS / 电商平台、SaaS / 第三方服务、第三方登录 / OAuth、支付系统、广告 / 营销、统计 / 分析平台和标签脚本。
...
- 分类 Tab 过滤：按前端框架、前端库、UI / CSS 框架、CDN / 托管、Web 服务器、开发语言 / 运行时、网站程序、探针 / 监控、RSS / 订阅、第三方登录 / OAuth、支付系统、广告 / 营销、统计 / 分析等分类查看结果。
...
- 可枚举规则集中放在 `tech-rules.json`，包括 RSS / 订阅、网站程序、探针 / 监控、第三方登录 / OAuth、支付系统、开发语言 / 运行时、广告 / 营销、统计 / 分析平台、补充 CDN、补充后端、补充 SaaS 等。
