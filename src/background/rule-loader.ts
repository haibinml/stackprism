...
export async function loadStackPrismRules(): Promise<RuleConfig> {
...
function normalizeRulePath(file: string) {
...
function mergeRulePartial(target: any, source: any) {
...
function normalizeRuleValue(value: any): any {
  if (Array.isArray(value)) {
...
function normalizeRuleArrayItem(item: any, defaults: any): any {
  if (isRuleGroup(item)) {
...
function expandRuleGroup(group: any, inheritedDefaults: any) {
  const defaults = {
    ...inheritedDefaults,
