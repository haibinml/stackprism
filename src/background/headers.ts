...
export function buildHeaderRecord(details: any, headerRules: any, settings: any) {
...
function normalizeHeaders(responseHeaders: any[]) {
...
function pickHeaders(headers: Record<string, string>, interestingNames: string[]) {
...
export function addStoredCustomHeaderRules(data: any, settings: any) {
...
function addCustomRulesToHeaderRecord(record: any, customRules: any[]) {
...
function detectCustomHeaderRules(record: any, customRules: any[]) {
...
export function dedupeApiRecords(records: any[]) {
...
function detectFromHeaders(headers: Record<string, string>, url: string, headerRules: any = {}, settings: any = {}) {
  const technologies: any[] = []
  const add = createCollector(technologies, '响应头')
...
function applyHeaderValueRuleList(add: any, rules: any[], value: string, rawValue: string, headerName: string) {
